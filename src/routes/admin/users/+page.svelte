  ...
  >
    ...
    >
      ...
      <div class="mb-6">
        ...
        <div
          class="flex items-center justify-between gap-3 px-4 py-3 bg-surface-input border border-border-input rounded-lg"
        >
          ...
          {#if data.isStrictAdmin}
            <Button variant="ghost" size="sm" href="/admin/staff?q={editingUser.steamId}">
              Manage in Staff
            </Button>
          {/if}
        </div>
