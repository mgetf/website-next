...
<div class="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
  <div class="max-w-5xl w-full">
    <div class="text-center mb-12">
      ...
      <p class="text-gray-400 text-lg">Sign up for the upcoming season</p>
    </div>
    ...
    {:else}
      ...
      <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {#if data.canCreateNew}
            ...
            >
              <div class="text-center">
                ...
                <p class="text-gray-400 mb-4">Start fresh with a brand new team for this season</p>
                <div
                  class="inline-block px-4 py-2 bg-orange-600 text-white rounded-lg group-hover:bg-orange-500 transition-colors"
                >
                  Get Started →
                </div>
              </div>
          ...
          {:else}
            <div
              class="bg-zinc-900 border border-zinc-800 rounded-lg p-8 opacity-60 cursor-not-allowed"
            >
              <div class="text-center">
                <div class="text-6xl mb-4">✨</div>
                <h2 class="text-2xl font-bold text-white mb-3">Create New Team</h2>
                <p class="text-gray-400 mb-4">Start fresh with a brand new team for this season</p>
                <div
                  class="inline-block px-4 py-2 bg-gray-600 text-gray-300 rounded-lg cursor-not-allowed"
                >
                  Unavailable
                </div>
          ...
          {#if data.canReregister}
            ...
            >
              <div class="text-center">
                ...
                <p class="text-gray-400 mb-4">Sign up an existing team for the new season</p>
                <div
                  class="inline-block px-4 py-2 bg-blue-600 text-white rounded-lg group-hover:bg-blue-500 transition-colors"
                >
                  Continue →
                </div>
              </div>
            ...
            {#if data.can1v1Signup}
              ...
              >
                <div class="text-center">
                  ...
                  <p class="text-gray-400 mb-4">Sign up as an individual player for 1v1 matches</p>
                  <div
                    class="inline-block px-4 py-2 bg-purple-600 text-white rounded-lg group-hover:bg-purple-500 transition-colors"
                  >
                    Sign Up &rarr;
                  </div>
                </div>
      ...
      <div class="mt-8 text-center text-gray-500 text-sm">
        <p>
          Need help? Check out our <a href="/rulebook" class="text-orange-500 hover:text-orange-400"
            >rulebook</a
          > or join our Discord
        </p>
      </div>
