...
import { getSiteSettings, updateSiteSettings, updateFavicon } from '$lib/server/services/siteSettings';
import {
	getAllContent,
	upsertContent,
	getContent,
...
import { uploadToR2, saveTempFile, deleteTempFile, validateUploadedFile, isR2Available } from '$lib/server/utils/r2Upload';
...
export const load: PageServerLoad = async ({ locals }) => {
	...
	const [settings, allContent] = await Promise.all([getSiteSettings(), getAllContent()]);
