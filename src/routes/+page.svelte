...
<div class="min-h-screen">
  ...
  <section class="max-w-7xl mx-auto px-6 mb-16">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      {#if league2v2Data.signupsOpen}
        ...
        >
          ...
          <div class="bg-zinc-900 p-8 flex flex-col flex-grow">
            <p class="text-blue-400 text-sm font-bold tracking-widest uppercase mb-6">
      ...
      {:else}
        <div
          class="bg-zinc-900 rounded-xl p-8 border-2 border-blue-500 hover:border-blue-400 transition-all shadow-xl shadow-blue-500/10 hover:shadow-blue-500/20 flex flex-col"
        >
          <div class="mb-4">
          ...
          <div class="mb-6">
            ...
            <div class="space-y-2">
              {#if league2v2Data.topTeams.length > 0}
                ...
                {/each}
              {:else}
                <div class="text-center py-4 text-gray-500">No teams yet this season</div>
              {/if}
            </div>
          </div>
          <a
      ...
      {:else}
        <div
          class="bg-zinc-900 rounded-xl p-8 border-2 border-purple-500 hover:border-purple-400 transition-all shadow-xl shadow-purple-500/10 hover:shadow-purple-500/20 flex flex-col"
        >
          <div class="mb-4">
          ...
          <div class="mb-6">
            ...
            <div class="space-y-2">
              {#if league1v1Data.topEntries.length > 0}
                ...
                {/each}
              {:else}
                <div class="text-center py-4 text-gray-500">No players yet this season</div>
              {/if}
            </div>
          </div>
          <a
