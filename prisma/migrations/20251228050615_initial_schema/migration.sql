...
-- CreateEnum
CREATE TYPE "PlayerStatus" AS ENUM ('MEMBER', 'ADMIN', 'STATUS');
...
-- CreateEnum
CREATE TYPE "MapBanActionType" AS ENUM ('BAN', 'PICK');

-- CreateEnum
CREATE TYPE "ChampionshipStatus" AS ENUM ('REGISTRATION', 'IN_PROGRESS', 'COMPLETED');
...
CREATE TABLE "demo_report" (
    ...
    "status" "DemoStatus" NOT NULL DEFAULT 'REVIEW',
    "description" TEXT,
    "admin_id" TEXT,
    "admin_comments" TEXT,
...
CREATE TABLE "teams" (
    ...
    "status" "TeamStatus" NOT NULL DEFAULT 'UNREADY',
...
CREATE TABLE "denied_players" (
    ...
    CONSTRAINT "denied_players_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "teamname_history" (
    ...
    CONSTRAINT "teamname_history_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "map_ban_actions" (
    ...
    "player_steam_id" TEXT,
    "arena_id" INTEGER,
    "action_type" "MapBanActionType" NOT NULL,
...
-- AddForeignKey
ALTER TABLE "tournaments" ADD CONSTRAINT "tournaments_winner1_steam_id_fkey" FOREIGN KEY ("winner1_steam_id") REFERENCES "users"("steam_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tournaments" ADD CONSTRAINT "tournaments_winner2_steam_id_fkey" FOREIGN KEY ("winner2_steam_id") REFERENCES "users"("steam_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tournaments" ADD CONSTRAINT "tournaments_second_place1_steam_id_fkey" FOREIGN KEY ("second_place1_steam_id") REFERENCES "users"("steam_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tournaments" ADD CONSTRAINT "tournaments_second_place2_steam_id_fkey" FOREIGN KEY ("second_place2_steam_id") REFERENCES "users"("steam_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tournaments" ADD CONSTRAINT "tournaments_third_place1_steam_id_fkey" FOREIGN KEY ("third_place1_steam_id") REFERENCES "users"("steam_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tournaments" ADD CONSTRAINT "tournaments_third_place2_steam_id_fkey" FOREIGN KEY ("third_place2_steam_id") REFERENCES "users"("steam_id") ON DELETE SET NULL ON UPDATE CASCADE;
