...
<div class="min-h-[calc(100vh-4rem)] px-4 py-12">
  <div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8">
      ...
      <h1 class="text-4xl font-bold text-white mb-2">Create {data.formatLabel} Team</h1>
      <p class="text-text-body">
        Fill out the form below to register your team for the {data.formatLabel} season
      </p>
    </div>
