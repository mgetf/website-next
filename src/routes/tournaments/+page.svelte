          ...
          <div class="overflow-x-auto">
            <table class="w-full">
              <thead class="bg-zinc-900 border-b border-zinc-800">
                <tr>
                  <th scope="col" class="px-4 py-3 text-sm font-semibold text-gray-300 text-left"
                    >Tournament</th
                  >
                  <th scope="col" class="px-4 py-3 text-sm font-semibold text-gray-300 text-left"
                    >Date</th
                  ...
                  <tr class="hover:bg-zinc-800/50 transition-colors">
                    <td class="px-4 py-3 whitespace-nowrap">
                      <div class="flex items-center space-x-3">
                        ...
                        {:else}
                          <div
                            class="w-12 h-12 rounded bg-zinc-800 flex items-center justify-center text-2xl"
                          >
                            🏆
                          </div>
                        {/if}
                    ...
                    <td class="px-4 py-3 whitespace-nowrap">
                      {#if tournament.isTeamTournament}
                        <span
                          class="px-2 py-1 bg-purple-500/20 text-purple-300 rounded text-xs font-semibold border border-purple-500/30"
                        >
                          2v2
                        </span>
                      {:else}
                        <span
                          class="px-2 py-1 bg-blue-500/20 text-blue-300 rounded text-xs font-semibold border border-blue-500/30"
                        >
                          1v1
                        </span>
                      {/if}
                    ...
                    <td class="px-4 py-3 whitespace-nowrap">
                      {#if tournament.isTeamTournament}
                        ...
                        {/if}
                      {:else if tournament.winner1}
                        <div class="flex items-center space-x-2">
                          <span class="text-yellow-400 text-lg">🥇</span>
                          <a
                            href="/users/{tournament.winner1.steamId}"
                            class="flex items-center space-x-2 group/winner"
                          >
                            <img
                              src={tournament.winner1.steamAvatar || '/default-avatar.png'}
                              alt={tournament.winner1.steamUsername}
                            ...
                            />
                            <span
                              class="text-sm text-white font-semibold group-hover/winner:text-blue-400 transition-colors"
                            >
                    ...
                    <td class="px-4 py-3 whitespace-nowrap">
                      <div class="flex items-center gap-3">
                        ...
                        {#if data.isGlobalAdmin}
                          ...
                          >
                            <svg
                              class="w-5 h-5 transition-transform {expandedTournament ===
                              tournament.id
                                ? 'rotate-180'
                                : ''}"
                              fill="none"
        ...
        {#snippet cell(championship, col)}
          {#if col.key === 'championship'}
            <div class="flex items-center space-x-3 whitespace-nowrap">
              ...
              {:else}
                <div
                  class="w-12 h-12 rounded bg-gradient-to-br from-purple-900/30 to-zinc-800 flex items-center justify-center text-2xl"
                >
                  🌍
                </div>
              {/if}
          ...
          {:else if col.key === 'champion'}
            {#if championship.winnerUser}
              <a
                href="/users/{championship.winnerUser.steamId}"
      ...
      >
        {#snippet cell(fightNight, col)}
          {#if col.key === 'event'}
            <div class="flex items-center space-x-3 whitespace-nowrap">
              <div
                class="w-12 h-12 rounded bg-gradient-to-br from-red-900/30 to-zinc-800 flex items-center justify-center text-2xl flex-shrink-0"
              >
                🥊
              </div>
              <div>
          ...
          {:else if col.key === 'matchups'}
            <div class="text-sm text-gray-300 whitespace-nowrap">
              {fightNight.matchups?.length || 0}
              {(fightNight.matchups?.length || 0) === 1 ? 'Fight' : 'Fights'}
            </div>
            ...
            {#if fightNight.matchups && fightNight.matchups.length > 0}
              <div class="flex -space-x-2">
                ...
                {#if fightNight.matchups.length > 6}
                  <div
                    class="w-8 h-8 rounded-full bg-zinc-800 ring-2 ring-zinc-900 flex items-center justify-center"
                  >
