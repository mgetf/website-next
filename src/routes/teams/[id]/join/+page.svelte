...
<div class="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
  <div class="max-w-md w-full">
    <div class="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
      <!-- Team Header -->
      <div
        class="bg-gradient-to-r from-orange-600/20 to-orange-600/5 p-8 text-center border-b border-zinc-800"
      >
        {#if data.team.avatar}
          <img
      ...
      <div class="p-8">
        ...
        {:else}
          <div class="text-center mb-6">
            <p class="text-gray-300">Enter the team password to request joining this team</p>
          </div>
