...
<div class="notification-dropdown-container relative">
	...
	{#if open}
		<div class="absolute right-0 mt-2 w-80 bg-zinc-900 border border-zinc-800 rounded-lg shadow-xl overflow-hidden z-50">
			<!-- Header -->
							...
							<div class="flex items-start gap-3">
								...
								<div class="flex-shrink-0 mt-0.5">
									{#if notification.actor?.steamAvatar}
										...
										/>
									{:else}
										<div class="w-8 h-8 rounded-full bg-zinc-700 flex items-center justify-center text-lg">
