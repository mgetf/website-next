...
export const AuditAction = {
  ...
  PAYMENT_UNMARKED_MANUALLY: 'PAYMENT_UNMARKED_MANUALLY',
  ...
  DIVISION_BULK_COPIED: 'DIVISION_BULK_COPIED',
  ...
  RULEBOOK_PUBLISHED: 'RULEBOOK_PUBLISHED',
  ...
  STAFF_DISCORD_ORPHAN_STRIPPED: 'STAFF_DISCORD_ORPHAN_STRIPPED',
} as const;
